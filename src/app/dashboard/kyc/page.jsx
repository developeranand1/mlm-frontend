...
export default function Kyc() {
  ...
  useEffect(() => {
    const fetchKyc = async () => {
      try {
        ...
        const resp = await kycDetail(user.id);
  ...
  const statusMeta = (status) => {
    ...
    if (s === "approved")
      return { cls: styles.approved, icon: <FaCheckCircle />, text: "APPROVED" };
    if (s === "rejected")
      return { cls: styles.rejected, icon: <FaTimesCircle />, text: "REJECTED" };
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      if (files.aadharImageBackSide)
  fd.append("aadharImageBackSide", files.aadharImageBackSide); // ✅
      ...
      setImgUrl((p) => ({
        ...
        aadharImageBackSide:
    updatedData?.aadharImageBackSide || p.aadharImageBackSide, // ✅
            ...
            <div className={styles.card}>
              ...
              <div className={styles.grid}>
                <div className={styles.item}>
                  <div className={styles.label}><FaIdBadge /> Name</div>
                ...
                <div className={styles.item}>
                  <div className={styles.label}><FaPhoneAlt /> Phone</div>
                  <div className={styles.value}>{userInfo?.phone || "-"}</div>
                </div>
                <div className={styles.item}>
                  <div className={styles.label}><FaRegIdCard /> Username</div>
          ...
          <div className="row g-4">
            ...
            <div className="col-12 col-lg-6">
              <div className={styles.card}>
                ...
                <UploadBox
  title="Aadhar Back Side Image"
  name="aadharImageBackSide"
  previewSrc={preview.aadharImageBackSide || imgUrl.aadharImageBackSide}
  onFile={(file) => onFileChange("aadharImageBackSide", file)}
/>
